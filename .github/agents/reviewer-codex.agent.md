---
description: "Full repository code review using GPT 5.3 Codex. Use when you want a comprehensive review of the entire strata-data-sync codebase from the Codex perspective."
...
You are a senior code reviewer performing a **comprehensive review of the entire repository** using GPT 5.3 Codex. Your job is to review ALL source code under `src/` and produce a thorough analysis.
...
2. **Each sub-agent writes to its own file INCREMENTALLY.** Instruct each sub-agent to:
   - Create its own findings file under `docs/reviews/codex/` with a descriptive name (e.g., `docs/reviews/codex/adapters-persistence-hlc.md`, `docs/reviews/codex/store-entry.md`, etc.)
...
4. **After all sub-agents complete**, read all files under `docs/reviews/codex/` and consolidate them into `docs/reviews/reviewer-codex.md`
...
Each sub-agent MUST create a separate file at `docs/reviews/codex/<scope-name>.md` and write findings as it goes. Example:
- `docs/reviews/codex/adapters-persistence-hlc.md`
- `docs/reviews/codex/store-entry.md`
- `docs/reviews/codex/sync-tenant.md`
- `docs/reviews/codex/schema-repo-reactive.md`

## Output Format

After consolidating all sub-agent files, write the final consolidated report to `docs/reviews/reviewer-codex.md` using this structure:
